   ...
   const deleteItem = (id) => {
    ...
    >
        ...
        <div className='w-full flex justify-between'>
            ...
            <Link href={route('dealer.create','customer')}>
            ...
            <table className="w-full  ">
             ...
             return <tr key={object.id}>
                         ...
                         <td className='flex justify-center gap-5' >
                             <div onClick={()=>router.get(route('dealer.edit',{id:object.id, type:'customer'}))} className='bg-yellow-500 text-black rounded-full hover:cursor-pointer min-w-5 p-2 min-h-5' ><PencilSquareIcon className='min-w-5 h-auto' /></div>
                             <div onClick={()=>{setItem(object),setShowDelete(true)}} className='bg-red-500 text-white hover:cursor-pointer rounded-full min-w-5 p-2 min-h-5' ><TrashIcon className='min-w-5 h-auto' /></div>
